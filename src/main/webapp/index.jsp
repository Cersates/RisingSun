...
<!--[if lte IE 6]><link rel="resources/stylesheet" type="text/css" href="css/style-ie.css" media="screen, projection, tv" /><![endif]-->
			...
			<fieldset>
				<label></label>
					<div id="picture-input">
						...
						<input class="hledat" type="image" src="resources/img/search-button.gif" name="" value="Search" alt="Search" />
			</fieldset>
			</form>
			<!-- Search form end -->	
		...
		<div id="content-box">
					...
					<div class="box-bottom">
						<div id="box-in">
							<div class="article">
								...
								<h3><a href="#">My newest article about&hellip;</a></h3>
								<div class="info">
									<div class="info-in">
										<p>In <a href="#">Category4</a> &nbsp;|&nbsp; Author <a href="#">Name</a> &nbsp;|&nbsp; 
										<a href="#">23 comments</a> &nbsp;|&nbsp; <a href="#">RSS comments</a></p>
									</div>
								</div>
									<p><img class="float" src="resources/img/flower.jpg" alt="flower" width="128" height="96" />
									Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Nam vulputate turpis vel mauris. 
									Aenean sapien mauris, ultrices sed, rhoncus at, pellentesque sed, lectus. In hac habitasse 
									platea dictumst. Donec adipiscing, mauris eu varius consectetuer, nulla orci iaculis neque, 
									ac rhoncus est lacus in augue. Maecenas ac dolor. Vestibulum semper eleifend arcu. Sed leo. 
									Suspendisse vestibulum dolor sed eros ullamcorper tincidunt. Nulla at sapien vel mi fermentum 
									adipiscing. Sed sit amet orci vel nisl mattis pretium. Nullam tristique mi eu magna. Duis odio 
									ante, suscipit non, iaculis et, porta malesuada, neque. Suspendisse fringilla, purus dictum 
									pretium nonummy, leo leo ullamcorper felis, id semper quam neque sit amet ante. Ut nec mi. 
									Ut congue massa fermentum justo.</p>
									<p class="continue">[<a href="#">Continue&hellip;</a>]</p>
							</div>
							
							<div class="article">
								<div class="date">
									<p class="day"><span>17th</span></p>
									<p>02/08</p>
								</div>
								<h3><a href="#">My article about&hellip;</a></h3>
								<div class="info">
									<div class="info-in">
										<p>In <a href="#">Category5</a> &nbsp;|&nbsp; Author <a href="#">Name</a> &nbsp;|&nbsp; 
										<a href="#">64 comments</a> &nbsp;|&nbsp; <a href="#">RSS comments</a></p>
									</div>
								</div>
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Nam vulputate turpis vel mauris. 
									Aenean sapien mauris, ultrices sed, rhoncus at, pellentesque sed, lectus. In hac habitasse 
									platea dictumst. Donec adipiscing, <a href="#">mauris eu varius</a> consectetuer, nulla orci iaculis neque, 
									ac rhoncus est lacus in augue. Maecenas ac dolor. Vestibulum semper eleifend arcu. Sed leo. 
									Suspendisse vestibulum dolor sed eros ullamcorper tincidunt. Nulla at sapien vel mi fermentum 
									adipiscing. Sed sit amet orci vel nisl mattis pretium. Nullam tristique mi eu magna.</p>
									<p class="continue">[<a href="#">Continue&hellip;</a>]</p>
							</div>
							
							<div class="article">
								<div class="date">
									<p class="day"><span>16th</span></p>
									<p>02/08</p>
								</div>
								<h3><a href="#">My article about&hellip;</a></h3>
								<div class="info">
									<div class="info-in"><p>In <a href="#">Category2</a> &nbsp;|&nbsp; Author <a href="#">Name</a> &nbsp;|&nbsp; 
									<a href="#">12 comments</a> &nbsp;|&nbsp; <a href="#">RSS comments</a></p>
									</div>
								</div>
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Nam vulputate turpis vel mauris. 
									Aenean sapien mauris, ultrices sed, rhoncus at, pellentesque sed, lectus. In hac habitasse 
			...
			<div id="content-box-right">
				<div class="content-box-right-in">
					<h4>About me</h4>
						<img class="me" src="resources/img/me.jpg" alt="Me" width="65" height="70" />
